...
export const WORLD_LORE: Partial<Record<number, WorldLore>> = {
  ...
  9: {
    ...
    page2:
      'What settles around a hole is never the same twice. Set the same impurity down in four different hosts and you get four completely different answers, and every one of those answers belongs to the host, not to the defect.\n\nOne hole tells you something. The Decoherence brings thousands, and past a certain density they stop telling you anything. Everything in the crystal comes to rest exactly where it stands, each state shut in its own small pocket, unable to answer any question at all. Something out here held out against that longer than anything else on these scars. It answered hole after hole, every answer ringing through the whole of it, until the holes came faster than any answer could cross it. No two reports agree on what crystal it is. Every one of them says it is still answering.',
  },
  10: {
    page1:
...
export const RIVAL_TAUNTS: Partial<Record<number, RivalTaunt>> = {
  ...
  9: {
    part1:
      'A shard-fused golem rises out of the crust where the scars close into the pass, a tarnished crystal pocked with a thousand vacancies. Each one glows faintly, and none of the glows reaches the next. "Look at every hole in me. A thousand of them, and I have answered each one, exactly where it was made."',
    part2:
      '"Take an atom out of me anywhere you like and ask me what I do about it. I will tell you, right there, on the spot. Nothing in me carries the answer away. Nothing in me lets it wander off through the rest of me and come back changed. Every state I have stays exactly where it came to rest, and it has stayed there a very long time. That is how completely I answer. Come, quantum material. Ask."',
  },
  10: {
    part1:
...
export const WORLD_LORE_BRIEF: Partial<Record<number, WorldLore>> = {
  ...
  9: {
    ...
    page2:
      'The same impurity in four hosts gives four different answers, and every answer belongs to the host. The Decoherence brings thousands, until every state comes to rest in its own small pocket. Something out here answered hole after hole until no answer could cross it, and no two reports agree on what crystal it is.',
  },
  10: {
    page1:
