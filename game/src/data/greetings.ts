...
const ENCOUNTER_GREETINGS: Record<MaterialType, string> = {
  ...
  tensornet: '{name} shows up already entangled with your bad decisions.',
...
const VICTORY_LINES: Record<MaterialType, string> = {
  ...
  tensornet: 'The {name} decoheres out of the fight. Victory!',
...
const DEFEAT_LINES: Record<MaterialType, string> = {
  ...
  tensornet: "You get entangled in the {name}'s strategy and lose.",
