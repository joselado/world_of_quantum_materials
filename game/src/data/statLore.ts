...
export const STAT_LORE: Record<keyof Stats, string> = {
  quantumness:
    'How high your excitations sit above the quiet ground state. Energy is the first of the three numbers that name a quasiparticle, and it decides which doors open. A channel that needs a certain quantum of energy stays shut until something arrives carrying that much. Raise your Energy and more of your blows arrive carrying enough, so more of them land as coherent critical hits.',
  velocity:
