...
export const STORY_BEATS: Partial<Record<number, string>> = {
  ...
  5: 'The thousand weak links in the black ceramic fuse shut, grain into grain. The phase stops being a treaty between pieces and goes back to being one thing: a single wave with no seams to cross. The glacier stays superconducting. Out on the sea beyond it, spin waves still run down the coast where they should be still: the next front the Decoherence has opened.',
