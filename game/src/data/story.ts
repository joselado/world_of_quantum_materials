...
export const STORY_BEATS: Partial<Record<number, string>> = {
  ...
  3: 'The disorder drains from the tarnished silver, and its currents take their first step in a very long time, spin welded to direction, walking straight past every flaw that used to stop them. The seam holds, and the bulk stays where it is. Further on, the ground falls into flat glowing bands under a storm that never breaks: untouched territory for whatever is unraveling these worlds.',
  4: "Order settles back through the slate-dark layers sheet by sheet, loops closing where they could not close, and what stood in the pass carries a whole number again, exact and unshaken. The flats' orbits lock back into their levels. Beyond them, an open glacier runs cold enough for zero resistance, and for Majorana pairs to hide in plain sight.",
  5: 'The thousand weak links in the black ceramic fuse shut, grain fusing to grain, and the phase stops being a treaty between pieces and goes back to being one thing, a single wave with no seams to cross. The glacier stays superconducting. Out on the black iron sand beyond it, spin waves still ripple where they should be still: the next front the Decoherence has opened.',
  6: 'The boundaries in the iron let go, grain growing into grain, and the first wave to cross it in an age passes through without scattering and out over the steppe. Past it, an entire world is nothing but bonds and entanglement, hung in nothing at all. If the Decoherence can unravel that, it can unravel anything.',
  7: 'The fracture lines in the pale green mineral seal, and the one state no piece was ever holding spreads back across every piece at once, whole precisely because it lives nowhere in particular. The network holds its bonds. Past its last rung the lanes give onto black water that fractionalizes everything entering it: spin liquids that never settle on an order of their own.',
  8: 'The stacking faults in the brown-black layers heal seam by seam, and what comes apart in it now travels, halves crossing the whole crystal with no boundary left to confine them. The water settles into something you can name again. Ahead the ground itself is scarred, old burns closed over and crust still open and glowing between them: defects and impurities, the Decoherence wearing through the material.',
  9: "The flaw disperses, and the ground it borrowed goes back to being ground. There was nothing in it to free: the one thing on this road with no coherence to lose has none to be handed back. The scars close. What's left is a world that re-forms around you as you walk and takes the ground back behind you: adaptive, watching, the last and strangest phase of matter you'll face.",
};
