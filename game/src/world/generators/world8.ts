// World 8 (quantum magnetism, spinons, Kondo): the corridor occasionally
// splits into two thin parallel paths for a stretch -- fractionalization,
// one excitation briefly reading as two -- before recombining into one,
// possibly more than once along the same journey, unlike world1.ts's single
// mean-field split (and left untinted, since fractionalization isn't
// picking between two distinct broken-symmetry ground states the way
// world1's split is).
